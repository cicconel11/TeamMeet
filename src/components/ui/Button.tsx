...
export const buttonVariants = (variant: ButtonProps["variant"] = "primary", size: ButtonProps["size"] = "md") => {
  ...
  const variants = {
    primary: "bg-org-primary text-white hover:opacity-90 focus:ring-org-primary",
    secondary: "bg-muted text-foreground hover:bg-border focus:ring-org-primary",
    ghost: "bg-transparent hover:bg-muted focus:ring-org-primary",
    danger: "bg-error text-white hover:opacity-90 focus:ring-error",
    custom: "focus:ring-org-primary",
  };
