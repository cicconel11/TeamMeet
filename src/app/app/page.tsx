        ...
        {hasOrgs ? (
          <>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-8">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">Your Organizations</h2>
              ...
              <div className="flex gap-3">
                <Link href="/app/join">
                  <Button variant="secondary">
                    <svg className="h-4 w-4 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
