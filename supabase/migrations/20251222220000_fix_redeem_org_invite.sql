-- Fix redeem_org_invite function to support token lookups and provide specific errors
...
BEGIN
  ...
  VALUES (v_user_id, v_invite.organization_id, v_invite.role::public.user_role, 'pending');
